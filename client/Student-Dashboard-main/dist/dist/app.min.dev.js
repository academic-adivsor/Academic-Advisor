...
var userMessage,
    ...
    chatDisplay = document.getElementById("chatbot"),
  ...
  return regeneratorRuntime.async(function (e) {
    for (;;) {
      switch (e.prev = e.next) {
        case 0:
          return "http://localhost:2020/api/v1/chat", t = {
            method: "POST",
            headers: {
          ...
          }, e.prev = 2, e.next = 5, regeneratorRuntime.awrap(fetch("http://localhost:2020/api/v1/chat", t));

        case 5:
          if ((a = e.sent).ok) return e.next = 9, regeneratorRuntime.awrap(a.json());
          e.next = 15;
          break;

        case 9:
          n = e.sent, c = n.botResponse, chatDisplay.innerHTML += "<div>User: ".concat(userMessage, "</div>"), chatDisplay.innerHTML += "<div>Bot: ".concat(c, "</div>"), e.next = 16;
          break;

        case 15:
          console.error("Error communicating with the server. Status: ".concat(a.status, ", ").concat(a.statusText));
        ...
        case 18:
          e.prev = 18, e.t0 = e["catch"](2), console.error("Error:", e.t0.message), console.error(e.t0.stack);

        case 22:
          return e.prev = 22, chatbox.scrollTo(0, chatbox.scrollHeight), e.finish(22);
  ...
  return regeneratorRuntime.async(function (e) {
    for (;;) {
      switch (e.prev = e.next) {
        ...
        case 3:
          return chatInput.value = "", chatbox.appendChild(createChatLi(userMessage, "outgoing")), chatbox.scrollTo(0, chatbox.scrollHeight), t = createChatLi("Thinking...", "incoming"), chatbox.appendChild(t), chatbox.scrollTo(0, chatbox.scrollHeight), e.next = 11, regeneratorRuntime.awrap(generateResponse(t));
