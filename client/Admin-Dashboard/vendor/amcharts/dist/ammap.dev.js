...
(function () {
  ...
  d.polygon = function (a, b, c, e, g, f, k, h, l, m, n) {
    ...
    var p = e,
        r = !1;
    "object" == _typeof(p) && 1 < p.length && (r = !0, p = p[0]);
    void 0 === k && (k = p);
    g = {
      fill: p,
      stroke: k,
...
(function () {
  ...
  d.AmMap = d.Class({
    ...
    zoomToGroup: function zoomToGroup(a) {
      a = "object" == _typeof(a) ? a : this.getGroupById(a);
      var b, c, d, g, f;
      ...
      if (c) {
        ...
        for (g = 0; g < h; g++) {
          ...
          if (0 !== f.childNodes.length || "" !== m || !1 !== n) if (3 == f.nodeType || 4 == f.nodeType) {
            ...
            var p;
            void 0 !== a[b][l] ? void 0 === a[b][l].length ? (p = a[b][l], a[b][l] = [], a[b][l].push(p), a[b][l].push({}), p = a[b][l][1]) : "object" == _typeof(a[b][l]) && (a[b][l].push({}), p = a[b][l][a[b][l].length - 1]) : (a[b][l] = {}, p = a[b][l]);
...
(function () {
  ...
  d.ObjectList = d.Class({
    ...
    init: function init(a) {
      ...
      this.div = "object" != _typeof(b) ? document.getElementById(b) : b;
      b = document.createElement("div");
