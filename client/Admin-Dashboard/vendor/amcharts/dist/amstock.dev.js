...
(function () {
  ...
  e.AmStockChart = e.Class({
    ...
    afterWrite: function afterWrite(a) {
      ...
      a = "object" != _typeof(a) ? document.getElementById(a) : a;
    ...
    setDefaultPeriod: function setDefaultPeriod() {
    ...
    getLastDate: function getLastDate(a) {
    ...
    getFirstDate: function getFirstDate(a) {
    ...
    updateData: function updateData() {
      ...
      if (b) {
        ...
        -1 == e.getItemIndex(c.minPeriod, c.groupToPeriods) && c.groupToPeriods.unshift(c.minPeriod);
    ...
    isDataParsed: function isDataParsed() {
      if (this.mainDataSet) {
    ...
    updateComparingData: function updateComparingData() {
    ...
    delayedParseStockData: function delayedParseStockData(a, b) {
      var c = this,
    ...
    parseStockData: function parseStockData(a, b, c, d, k) {
      var g = this,
          l = {},
          h = a.dataProvider,
          n = a.categoryField;
        ...
        for (q = 0; q < t; q++) {
          ...
          for (z = f; z < m; z++) {
            ...
            if (z == f || C >= y[p] || !y[p]) {
              ...
              for (H = 0; H < E; H++) {
                u = A[H].toField, w = v[p], null !== r[u] && (x = Number(r[u]), w[u + "Count"] = 0, isNaN(x) || (w[u + "Open"] = x, w[u + "Sum"] = x, w[u + "High"] = x, w[u + "AbsHigh"] = x, w[u + "Low"] = x, w[u + "Close"] = x, w[u + "Count"] = 1, w[u + "Average"] = x));
              }
              ...
              if (z == f) for (var I in B) {
                B.hasOwnProperty(I) && (v[p][I] = B[I]);
              }
              v[p][n] = e.newDate(D, b);
            } else for (w = v[p], w.rawData && w.rawData.push(B), p = 0; p < E; p++) {
    ...
    parseEvents: function parseEvents(a, b, c, d, k, g) {
      d = a.stockEvents;
      d.sort(function (a, b) {
      ...
      for (n = 0; n < h; n++) {
        ...
        for (f = 0; f < m; f++) {
          q = t[f], q.customBulletField = "amCustomBullet" + q.id + "_" + p.id, q.bulletConfigField = "amCustomBulletConfig" + q.id + "_" + p.id, q.chart = p;
        }

        for (f = 0; f < d.length; f++) {
          m = d[f], q = m.graph, e.isString(q) && (q = e.getObjById(t, q)) && (m.graph = q), q && (m.panel = q.chart);
        }
      }

      for (var y in l) {
        if (l.hasOwnProperty(y)) for (b = l[y], h = e.extractPeriod(y), n = b.length, f = 0; f < d.length; f++) {
          m = d[f];
    ...
    getEventDataItem: function getEventDataItem(a, b, c, d, k, g) {
      var l = g.period,
          h = g.count,
    ...
    measurePanels: function measurePanels(a) {
      this.measure();
    ...
    addStockPanel: function addStockPanel(a, b) {
    ...
    enableCursors: function enableCursors(a) {
    ...
    updatePanel: function updatePanel(a) {
    ...
    updatePanelsWithNewData: function updatePanelsWithNewData() {
      var a = this.mainDataSet,
    ...
    addChartScrollbar: function addChartScrollbar() {
    ...
    addPeriodSelector: function addPeriodSelector() {
      var a = this.periodSelector;
    ...
    addDataSetSelector: function addDataSetSelector() {
    ...
    handlePeriodSelectorZoom: function handlePeriodSelectorZoom(a) {
    ...
    addCursor: function addCursor(a) {
    ...
    handleZoom: function handleZoom(a) {
      this.zoomChart(a.startDate, a.endDate);
    },
    zoomChart: function zoomChart(a, b) {
      var c = this;
      a || (a = c.firstDate);
      var d = e.newDate(a),
          k = c.firstDate,
        ...
        for (k = 0; k < q.length; k++) {
          ...
          if (l != h) {
            for (d = 0; d < t.length; d++) {
              A = t[d].graph, A.dataProvider = A.dataSet.agregatedDataProviders[l];
            }
    ...
    passFields: function passFields(a, b) {
    ...
    choosePeriod: function choosePeriod(a, b, c) {
    ...
    getSelections: function getSelections() {
      ...
      for (c = 0; c < b.length; c++) {
        d = b[c], d.hideDrawingIcons && ("never" != d.recalculateToPercents && 0 < a.length ? d.hideDrawingIcons(!0) : d.drawingIconsEnabled && d.hideDrawingIcons(!1));
      }
    },
    addPanel: function addPanel(a) {
      this.panels.push(a);
      this.prevPH = void 0;
      e.removeChart(a);
      e.addChart(a);
    },
    addPanelAt: function addPanelAt(a, b) {
    ...
    validateDataReal: function validateDataReal(a) {
    ...
    resetDataParsed: function resetDataParsed() {
      var a = this.dataSets,
          b;
    ...
    hideStockEvents: function hideStockEvents() {
      this.showHideEvents(!1);
      this.eventsHidden = !0;
    },
    showStockEvents: function showStockEvents() {
      this.showHideEvents(!0);
      this.eventsHidden = !1;
    },
    showHideEvents: function showHideEvents(a) {
      var b = this.panels,
          c;
    ...
    validateSizeReal: function validateSizeReal() {
...
(function () {
  ...
  e.PeriodSelector = e.Class({
    ...
    write: function write(a) {
      ...
      b.position = g;
      b.div = a;
      a.innerHTML = '<fieldset style="border: none; padding:0"><legend style="display: none;">' + (c.langObj.periodSelectorAccessibilityText || b.accessibilityText) + "</legend></fieldset>";
      var l = a.firstChild;
      a = b.theme;
      k = b.position;
      ...
      if (b.inputFieldsEnabled) {
        ...
        n.appendChild(m);
        b.startDateField = m;
        if (k) f = b.width - 6 + "px", e.addBr(n);else {
    ...
    addEventListeners: function addEventListeners(a) {
      var b = this;
    ...
    handleCalendarChange: function handleCalendarChange(a) {
      13 == a.keyCode && this.handleCalChange(a);
    },
    handleCalChange: function handleCalChange(a) {
    ...
    handlePeriodChange: function handlePeriodChange(a) {
      this.selectPeriodButton((a.srcElement ? a.srcElement : a.target).periodObj, !1, a);
    },
    setRanges: function setRanges(a, b) {
      this.firstDate = a;
      this.lastDate = b;
      this.getPeriodDates();
    },
    selectPeriodButton: function selectPeriodButton(a, b, c) {
      var d = a.button,
          k = d.count,
          g = d.period,
          l = this.chart,
    ...
    markButtonAsSelected: function markButtonAsSelected() {
      if (!this.skipMark) {
        var a = this.chart,
            b = this.periods,
    ...
    unselectButtons: function unselectButtons() {
      var a = this.chart,
          b = this.periods,
          c,
          d = this.theme;
...
(function () {
  ...
  e.StockPanel = e.Class({
    ...
    initChart: function initChart(a) {
    ...
    addStockGraph: function addStockGraph(a) {
    ...
    removeStockGraph: function removeStockGraph(a) {
    ...
    createDrawIcons: function createDrawIcons() {
      var a = this,
          b = a.iconSize,
          c = a.container,
          d = a.pathToImages,
    ...
    handlePencilClick: function handlePencilClick() {
    ...
    setTrendColorHover: function setTrendColorHover(a) {
    ...
    handleDraw: function handleDraw(a) {
    ...
    hideDrawingIcons: function hideDrawingIcons(a) {
      (this.hideIcons = a) && this.disableDrawing(a);
    },
    handleTrendClick: function handleTrendClick(a) {
...
(function () {
  ...
  e.ChartCursorSettings = e.Class({
    ...
    categoryBalloonDateFormat: function categoryBalloonDateFormat(a) {
...
(function () {
  ...
  e.StockLegend = e.Class({
    ...
    drawLegend: function drawLegend() {
      ...
      if (b.allowTurningOff) {
        var c = a.container,
            ...
            b = c.image(b.pathToImages + "xIconH" + b.extension, b.realWidth - 19, 3, 19, 19);
        b.hide();
        a.xButtonHover = b;
        d.mouseup(function () {
          a.handleXClick();
    ...
    handleXOver: function handleXOver() {
      this.xButtonHover.show();
    },
    handleXOut: function handleXOut() {
      this.xButtonHover.hide();
    },
    handleXClick: function handleXClick() {
      var a = this.chart,
          b = a.stockChart;
      b.removePanel(a);
      b.validateNow();
...
(function () {
  ...
  e.DataSetSelector = e.Class({
    ...
    write: function write(a) {
      ...
      if (0 < b.countDataSets("showInCompare") && 1 < g.length) if (l ? (e.addBr(a), e.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(k.langObj.compareText || b.compareText), a.appendChild(c), f = b.listCheckBoxSize, l) {
        e.addBr(a);
    ...
    handleDataSetChange: function handleDataSetChange() {
      var a = this.selectCB,
    ...
    handleRollOver: function handleRollOver(a) {
      a = this.getRealDiv(a);
      a.dataSet.compared || (a.style.backgroundColor = this.rollOverBackgroundColor);
    },
    handleRollOut: function handleRollOut(a) {
      a = this.getRealDiv(a);
    ...
    handleCBSelect: function handleCBSelect(a) {
...
(function () {
  ...
  e.StackedBullet = e.Class({
    ...
    addLetter: function addLetter(a, b, c) {
    ...
    drawTriangleUp: function drawTriangleUp(a) {
      var b = this.fontSize + 7;
      return this.drawRealPolygon(a, [0, b / 2, -b / 2, 0], [0, b, b, 0]);
    },
    drawArrowUp: function drawArrowUp(a) {
      var b = this.size,
          c = b / 2,
          d = b / 4;
      return this.drawRealPolygon(a, [0, c, d, d, -d, -d, -c, 0], [0, c, c, b, b, c, c, 0]);
    },
    drawArrowDown: function drawArrowDown(a) {
      var b = this.size,
          c = b / 2,
          d = b / 4;
      return this.drawRealPolygon(a, [0, c, d, d, -d, -d, -c, 0], [0, -c, -c, -b, -b, -c, -c, 0]);
    },
    drawTriangleDown: function drawTriangleDown(a) {
      var b = this.fontSize + 7;
      return this.drawRealPolygon(a, [0, b / 2, -b / 2, 0], [0, -b, -b, 0]);
    },
    drawTriangleLeft: function drawTriangleLeft(a) {
      var b = this.fontSize + 7;
      return this.drawRealPolygon(a, [0, b, b, 0], [0, -b / 2, b / 2, 0]);
    },
    drawTriangleRight: function drawTriangleRight(a) {
      var b = this.fontSize + 7;
      return this.drawRealPolygon(a, [0, -b, -b, 0], [0, -b / 2, b / 2, 0]);
    },
    drawRealPolygon: function drawRealPolygon(a, b, c) {
      b = e.polygon(this.container, b, c, this.backgroundColor, this.backgroundAlpha, 1, this.borderColor, this.borderAlpha);
      a.push(b);
      this.cset.push(a);
      return b;
    },
    drawCircle: function drawCircle(a) {
    ...
    drawTextBackground: function drawTextBackground(a, b) {
      var c = b.getBBox(),
          d = -c.width / 2 - 5,
          e = c.width / 2 + 5,
          c = -c.height - 12;
    ...
    handleMouseOver: function handleMouseOver(a, b) {
      ...
      c = d.graphs;
      if (d.chartCursor && d.chartCursor.valueBalloonsEnabled) for (k = 0; k < c.length; k++) {
        c[k].hideBalloon();
      }
    },
    handleClick: function handleClick(a) {
    ...
    handleMouseOut: function handleMouseOut(a) {
      this.bullets[a].attr({
