  ...
  AmCharts["export"] = function (t, r) {
    var s,
      ...
      setup: {
        ...
        hasTouch: "object" == _typeof(window.Touch),
        ...
        handler: {
          ...
          change: function change(c, u, f) {
            ...
            if (h.mode && (d.drawing.mode = h.mode), h.width && (d.drawing.width = h.width, d.drawing.fontSize = h.fontSize = 3 * h.width, 1 == d.drawing.width && (d.drawing.fontSize = h.fontSize = d.defaults.fabric.drawing.fontSize)), h.fontSize && (d.drawing.fontSize = h.fontSize), h.color && (d.drawing.color = h.color), h.opacity && (d.drawing.opacity = h.opacity), N = d.getRGBA(d.drawing.color), N.pop(), N.push(d.drawing.opacity), d.drawing.color = "rgba(" + N.join() + ")", d.setup.fabric.freeDrawingBrush.color = d.drawing.color, d.setup.fabric.freeDrawingBrush.width = d.drawing.width, S) {
              for (m = JSON.parse(S.recentState).cfg, m && (h.color = h.color || m.color, h.width = h.width || m.width, h.opacity = h.opacity || m.opacity, h.fontSize = h.fontSize || m.fontSize, N = d.getRGBA(h.color), N.pop(), N.push(h.opacity), h.color = "rgba(" + N.join() + ")"), S.changed = !0, w = 0; w < T.length; w++) {
                T[w] instanceof fabric.Text || T[w] instanceof fabric.PathGroup || T[w] instanceof fabric.Triangle ? ((h.color || h.opacity) && T[w].set({
                  fill: h.color
                }), h.fontSize && T[w].set({
                  fontSize: h.fontSize
      ...
      prepareGroupState: function prepareGroupState(c) {
        return c = c || {}, delete c.width, delete c.strokeWidth, c;
      },
      getState: function getState(c) {
        var u = c.saveState();
        return u._stateProperties || u.originalState;
      },
      download: function download(c, u, f) {
      ...
      addListenerToRemove: function addListenerToRemove(c, u, f) {
      ...
      loadDependencies: function loadDependencies() {
        var c;
        if (d.libs.autoLoad) for (c = 0; c < d.libs.resources.length; c++) {
          d.libs.resources[c] instanceof Object ? Object.keys(d.libs.resources[c]).some(function (f) {
            d.loadResource(f, d.libs.resources[c][f]);
          }) : d.loadResource(d.libs.resources[c]);
        }
      },
      pxToNumber: function pxToNumber(c, u) {
        return !c && u ? void 0 : +(c + "").replace("px", "") || 0;
      },
      numberToPx: function numberToPx(c) {
        return c + "px";
      },
      cloneObject: function cloneObject(c) {
        var u, f, m, w;
        return u = Array.isArray(c) ? [] : {}, Object.keys(c).some(function (N) {
          f = c[N], m = "object" == _typeof(f), w = f instanceof Date, u[N] = m && !w ? d.cloneObject(f) : f;
        }), u;
      },
      deepMerge: function deepMerge(c, u, f) {
        var m,
      ...
      isElement: function isElement(c) {
        return c instanceof Object && c && 1 === c.nodeType;
      },
      isHashbanged: function isHashbanged(c) {
        var u = (c + "").replace(/\"/g, "");
        return "url" == u.slice(0, 3) && u.slice(u.indexOf("#") + 1, u.length - 1);
      },
      isPressed: function isPressed(c) {
      ...
      removeImage: function removeImage(c) {
        if (c) {
      ...
      isTainted: function isTainted(c) {
      ...
      getAngle: function getAngle(c, u, f, h) {
        var N,
            m = f - c,
            w = h - u;
      ...
      gatherAttribute: function gatherAttribute(c, u, f, h) {
        var m,
            h = h ? h : 0,
            f = f ? f : 3;
        return c && (m = c.getAttribute(u), !m && h < f) ? d.gatherAttribute(c.parentNode, u, f, h + 1) : m;
      },
      gatherClassName: function gatherClassName(c, u, f, h) {
        var m,
            h = h ? h : 0,
            f = f ? f : 3;
      ...
      gatherElements: function gatherElements(c, u, f) {
        var h, m;
        ...
        for (h = 0; h < c.children.length; h++) {
          ...
          if ("clipPath" == w.tagName) {
            ...
            for (m = 0; m < w.childNodes.length; m++) {
              w.childNodes[m].setAttribute("fill", "transparent"), N = {
            ...
            for (m = 0; m < w.childNodes.length; m++) {
              if ("rect" == w.childNodes[m].tagName) T.fill = w.childNodes[m].getAttribute("fill");else if ("image" == w.childNodes[m].tagName) {
      ...
      modifyFabric: function modifyFabric() {
        fabric.ElementsParser.prototype.resolveGradient = function (c, u) {
          ...
          var h = "",
              m = [];
          if (!("textContent" in c)) "firstChild" in c && null !== c.firstChild && "data" in c.firstChild && null !== c.firstChild.data && m.push(c.firstChild.data);else if (c.childNodes) for (var w = 0; w < c.childNodes.length; w++) {
      ...
      capture: function capture(c, u) {
        ...
        if (d.config.legend) {
          if ("stock" == d.setup.chart.type) for (f = 0; f < d.setup.chart.panels.length; f++) {
            d.setup.chart.panels[f].stockLegend && d.setup.chart.panels[f].stockLegend.divId && S.items.push(d.setup.chart.panels[f].stockLegend);
        ...
        for (d.setup.fabric = new fabric.Canvas(d.setup.canvas, D), d.deepMerge(d.setup.fabric, h), d.deepMerge(d.setup.fabric.freeDrawingBrush, h.drawing), d.deepMerge(d.drawing, h.drawing), d.drawing.handler.change(h.drawing), d.setup.fabric.on("mouse:down", function (E) {
          ...
          if (d.isPressed(E.e), d.drawing.buffer.isPressed && !d.drawing.buffer.isSelected && (d.drawing.buffer.isDrawing = !0, !d.drawing.buffer.line && "pencil" != d.drawing.mode && (5 < I.xD || 5 < I.yD) && (d.setup.fabric.isDrawingMode = !1, d.setup.fabric._isCurrentlyDrawing = !1, d.drawing.buffer.ignoreUndoOnMouseUp = !0, d.setup.fabric.freeDrawingBrush.onMouseUp(), d.setup.fabric.remove(d.setup.fabric._objects.pop()), d.drawing.buffer.line = d.drawing.handler.line({
            ...
            for (G.x2 = I.x2, G.y2 = I.y2, f = 0; f < G.group.length; f++) {
              P = G.group[f], P instanceof fabric.Line ? P.set({
                x2: G.x2,
                y2: G.y2
            ...
            return function (I, P) {
              ...
              if (G.paths = z, G.set(U), d.setup.fabric.add(G), E.svg.parentNode && E.svg.parentNode.getElementsByTagName) {
                ...
                for (O = 0; O < W.length; O++) {
                  if (h.balloonFunction instanceof Function) h.balloonFunction.apply(d, [W[O], E]);else {
                    var _ = W[O],
      ...
      toCanvas: function toCanvas(c, u) {
        var f = d.deepMerge({}, c || {}),
            h = d.setup.canvas;
        return d.handleCallback(u, h, f), h;
      },
      toImage: function toImage(c, u) {
        var f = d.deepMerge({
          format: "png",
          quality: 1,
      ...
      toSVG: function toSVG(c, u) {
        var w,
            f = [],
            h = [],
            m = d.deepMerge({
          compress: d.config.compress,
          reviver: function reviver(T, A) {
      ...
      toPRINT: function toPRINT(c, u) {
        ...
        for (m.setAttribute("style", "width: 100%; max-height: 100%;"), f = 0; f < N.length; f++) {
          d.isElement(N[f]) && (w[f] = N[f].style.display, N[f].style.display = "none");
        }
      ...
      toByteArray: function toByteArray(c, u) {
        function f(D) {
        ...
        var m = d.deepMerge({}, c || {}),
          ...
          for (I = 0, P = 0; I < O; I += 4, P += 3) {
            B = f(D.charAt(I)) << 18 | f(D.charAt(I + 1)) << 12 | f(D.charAt(I + 2)) << 6 | f(D.charAt(I + 3)), E((16711680 & B) >> 16), E((65280 & B) >> 8), E(255 & B);
          }
      ...
      removeFunctionsFromObject: function removeFunctionsFromObject(c) {
        return Object.keys(c).some(function (u) {
          "function" == typeof c[u] && delete c[u];
        }), c;
      },
      handleCallback: function handleCallback(c) {
        var u,
            f = [];
      ...
      handleLog: function handleLog(c) {
        !0 === d.config.debug && console.log(c);
      },
      handleNamespace: function handleNamespace(c, u) {
        function f() {
          var S = +new Date();
      ...
      handleBorder: function handleBorder(c) {
      ...
      handleDropbox: function handleDropbox(c) {
        if (d.drawing.enabled) if (c.preventDefault(), c.stopPropagation(), "dragover" == c.type) d.setup.wrapper.setAttribute("class", d.setup.chart.classNamePrefix + "-export-canvas active dropbox");else if (d.setup.wrapper.setAttribute("class", d.setup.chart.classNamePrefix + "-export-canvas active"), "drop" == c.type && c.dataTransfer.files.length) for (var f, u = 0; u < c.dataTransfer.files.length; u++) {
          f = new FileReader(), f.onloadend = function (h) {
            return function () {
      ...
      handleReady: function handleReady(c) {
        var h = this,
            m = +new Date();
      ...
      getChartData: function getChartData(c) {
        function u(U, H, X) {
          function W(_, Y) {
        ...
        if (0 == f.data.length) if ("stock" == d.setup.chart.type) {
          ...
          for (m = 0; m < d.setup.chart.dataProvider.length; m++) {
            ...
            if (O[P]) for (w = 0; w < O[P].length; w++) {
              O[P][w][d.setup.chart.categoryField] = O[d.setup.chart.categoryField], f.data.push(O[P][w]);
            }
          }
      ...
      getAnnotations: function getAnnotations(c, u) {
        var h,
            f = d.deepMerge({}, c || {}, !0),
            m = [];
      ...
      setAnnotations: function setAnnotations(c, u) {
        var f = d.deepMerge({
          data: []
        }, c || {}, !0);
      ...
      createMenu: function createMenu(c, u) {
        function f(w, N) {
          var S,
              T,
      ...
      migrateSetup: function migrateSetup(c) {
        function u(h) {
      ...
      clear: function clear() {
        ...
        for (void 0 !== d.setup.fabric && d.setup.fabric.removeListeners(), c = 0; c < d.listenersToRemove.length; c++) {
          u = d.listenersToRemove[c], u.node.removeEventListener(u.event, u.method);
        }
