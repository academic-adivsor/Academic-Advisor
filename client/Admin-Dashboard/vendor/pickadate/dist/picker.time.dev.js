...
!function (a) {
  ...
  c.prototype.set = function (a, b, c) {
    ...
    var d = this,
        e = function e(a) {
      return !0 === a || b.isArray(a) || _h.isDate(a) ? d.create(a) : a;
    };
    ...
    var g = this;
    return c || (c = "min" == a ? [0, 0] : [d - 1, e - 1]), "string" == typeof c ? c = g.parse(a, c) : !0 === c || _h.isInteger(c) ? c = g.now(a, c, f) : b.isPlainObject(c) && _h.isInteger(c.pick) && (c = g.normalize(a, c.pick, f)), c;
    ...
    for (i in l) {
      j = l[i], _h.isInteger(j) ? i.match(/^(h|hh)$/i) ? (d = j, "h" != i && "hh" != i || (d %= 12)) : "i" == i && (f = j) : i.match(/^a$/i) && j.match(/^p/i) && ("h" in l || "hh" in l) && (g = !0);
    }
    ...
    var d = this;
    return _h.isInteger(a) && _h.isInteger(c) || "boolean" == typeof a && "boolean" == typeof c ? a === c : (_h.isDate(a) || b.isArray(a)) && (_h.isDate(c) || b.isArray(c)) ? d.create(a).pick === d.create(c).pick : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && d.isTimeExact(a.from, c.from) && d.isTimeExact(a.to, c.to);
  }, c.prototype.isTimeOverlap = function (a, c) {
    var d = this;
    return _h.isInteger(a) && (_h.isDate(c) || b.isArray(c)) ? a === d.create(c).hour : _h.isInteger(c) && (_h.isDate(a) || b.isArray(a)) ? c === d.create(a).hour : !(!b.isPlainObject(a) || !b.isPlainObject(c)) && d.overlapRanges(a, c);
    ...
    return "flip" == c ? d.flipEnable() : !0 === c ? (d.flipEnable(1), e = []) : !1 === c ? (d.flipEnable(-1), e = []) : c.map(function (a) {
      ...
      if (c) for (i = 0; i < f; i += 1) {
        if (d.isTimeExact(e[i], a)) {
          e[i] = null;
          break;
        }
      }
      if (j) for (i = 0; i < f; i += 1) {
