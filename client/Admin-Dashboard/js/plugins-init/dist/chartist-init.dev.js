...
(function ($) {
  ...
  var dzChartlist = function () {
    ...
    var setChartWidth = function setChartWidth() {
      if (screenWidth <= 768) {
    ...
    var lineAnimatedChart = function lineAnimatedChart() {
    ...
    var scatterChart = function scatterChart() {
    ...
    var simpleLineChart = function simpleLineChart() {
      //Simple line chart
    ...
    var lineTooltipsChart = function lineTooltipsChart() {
    ...
    var withAreaChart = function withAreaChart() {
    ...
    var biPolarLineChart = function biPolarLineChart() {
    ...
    var svgAnimationChart = function svgAnimationChart() {
      //SVG Path animation
    ...
    var lineSmoothingChart = function lineSmoothingChart() {
    ...
    var biPolarBarChart = function biPolarBarChart() {
      //Bi-polar bar chart
      var data = {
    ...
    var overlappingBarsChart = function overlappingBarsChart() {
    ...
    var extremeChart = function extremeChart() {
    ...
    var labelPlacementChart = function labelPlacementChart() {
      //Label placement
    ...
    var animatingDonutChart = function animatingDonutChart() {
    ...
    var gaugeChart = function gaugeChart() {
      //Gauge chart
    ...
    var differentSeriesChart = function differentSeriesChart() {
    ...
    var svgDotAnimationChart = function svgDotAnimationChart() {
