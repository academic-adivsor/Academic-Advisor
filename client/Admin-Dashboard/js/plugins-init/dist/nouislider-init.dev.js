...
(function ($) {
  "use strict"; //basic slider

  var basicSlide = document.getElementById('basic-slider');
  ...
  var keyboardslider = document.getElementById('keyboardslider');
  ...
  var dateValues = [document.getElementById('event-start'), document.getElementById('event-end')]; // Create a list of day and month names.
