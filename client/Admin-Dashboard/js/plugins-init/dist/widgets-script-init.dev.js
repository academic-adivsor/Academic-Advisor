...
(function ($) {
  ...
  if (jQuery('#chart_widget_1').length > 0) {
    var chart_widget_1 = document.getElementById("chart_widget_1").getContext('2d'); //generate gradient
  ...
  if (jQuery('#chart_widget_2').length > 0) {
    var chart_widget_2 = document.getElementById("chart_widget_2").getContext('2d'); //generate gradient

    var chart_widget_2gradientStroke = chart_widget_2.createLinearGradient(0, 0, 0, 250);
    chart_widget_2gradientStroke.addColorStop(0, "#6673fd");
    chart_widget_2gradientStroke.addColorStop(1, "#f24a87"); // chart_widget_2.attr('height', '100');
  ...
  if (jQuery('#chart_widget_3').length > 0) {
    var chart_widget_3 = document.getElementById("chart_widget_3").getContext('2d'); // chart_widget_3.height = 100;
  ...
  if (jQuery('#chart_widget_4').length > 0) {
    var chart_widget_4 = document.getElementById("chart_widget_4").getContext('2d'); // chart_widget_4.height = 100;
  ...
  if (jQuery('#chart_widget_7').length > 0) {
    var chart_widget_7 = document.getElementById("chart_widget_7").getContext('2d'); //generate gradient

    var chart_widget_7gradientStroke = chart_widget_7.createLinearGradient(0, 0, 0, 250);
    chart_widget_7gradientStroke.addColorStop(0, "#e3366b");
    chart_widget_7gradientStroke.addColorStop(1, "#e3366b"); // chart_widget_7.attr('height', '100');
  ...
  if (jQuery('#chart_widget_9').length > 0) {
    var chart_widget_9 = document.getElementById("chart_widget_9").getContext('2d');
  ...
  if (jQuery('#chart_widget_10').length > 0) {
    var chart_widget_10 = document.getElementById("chart_widget_10").getContext('2d');
  ...
  if (jQuery('#chart_widget_11').length > 0) {
    var chart_widget_11 = document.getElementById("chart_widget_11").getContext('2d');
  ...
  if (jQuery('#chart_widget_14').length > 0) {
    var chart_widget_14 = document.getElementById("chart_widget_14");
  ...
  if (jQuery('#chart_widget_15').length > 0) {
    var chart_widget_15 = document.getElementById("chart_widget_15");
  ...
  if (jQuery('#chart_widget_16').length > 0) {
    var chart_widget_16 = document.getElementById("chart_widget_16");
  ...
  if (jQuery('#chart_widget_17').length > 0) {
    var getRandomData = function getRandomData() {
      if (_data.length > 0) _data = _data.slice(1);

      while (_data.length < totalPoints) {
        var prev = _data.length > 0 ? _data[_data.length - 1] : 50,
    ...
    if (jQuery('#chart_widget_17').length > 0) {
      var update_chart = function update_chart() {
        _chart.setData([getRandomData()]);
      ...
      var _chart = $.plot('#chart_widget_17', [getRandomData()], {
        colors: ['#6673fd'],
        series: {
          lines: {
            show: true,
  ...
  if (jQuery('#widget_StackedBarChart').length > 0) {
    $('#widget_StackedBarChart').sparkline([[1, 4, 2], [2, 3, 2], [3, 2, 2], [4, 1, 2]], {
      type: "bar",
      height: "40",
      barWidth: 3,
      barSpacing: 3,
