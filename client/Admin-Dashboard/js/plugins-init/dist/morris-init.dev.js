  ...
  var dzMorris = function () {
    ...
    var donutChart = function donutChart() {
      Morris.Donut({
        ...
        resize: true,
        redraw: true,
        colors: ['#6673fd', 'rgb(255, 184, 0)', '#2bc155'] //responsive:true,
    ...
    var lineChart2 = function lineChart2() {
      //Area chart
      Morris.Area({
    ...
    var barStalkChart = function barStalkChart() {
      //bar chart
      Morris.Bar({
        ...
        barSizeRatio: 0.25,
        stacked: true,
        behaveLikeLine: true //redraw: true
        // barRadius: [6, 6, 0, 0]
    ...
    var areaChart2 = function areaChart2() {
      //area chart
      Morris.Area({
        ...
        pointSize: 0,
        fillOpacity: 0.6,
        pointStrokeColors: ['#b4becb', '#00A2FF'],
        //here
        behaveLikeLine: true,
        gridLineColor: 'transparent',
        lineWidth: 0,
