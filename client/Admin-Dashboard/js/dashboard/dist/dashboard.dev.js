...
(function ($) {
  ...
  var eduMin = function () {
    ...
    var morrisBarStalked = function morrisBarStalked() {
      if (jQuery('#morris_bar_stalked').length > 0) {
        ...
        Morris.Bar({
          ...
          barSizeRatio: 0.25,
          stacked: true,
          behaveLikeLine: true // barRadius: [6, 6, 0, 0]

        });
      }
    };

    var morrisDonught = function morrisDonught() {
    ...
    var morrisArea = function morrisArea() {
