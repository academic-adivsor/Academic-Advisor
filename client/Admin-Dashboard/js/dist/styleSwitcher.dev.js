...
function addSwitcher() {
  ...
  if ($("#dzSwitcher").length == 0) {
    ...
    var sr = new PerfectScrollbar('.sidebar-right-inner');
...
(function ($) {
  ...
  addSwitcher();
  var body = $('body');
  var html = $('html'); //get the DOM elements from right sidebar

  var typographySelect = $('#typography');
  var versionSelect = $('#theme_version');
  var layoutSelect = $('#theme_layout');
  var sidebarStyleSelect = $('#sidebar_style');
  var sidebarPositionSelect = $('#sidebar_position');
  var headerPositionSelect = $('#header_position');
  var containerLayoutSelect = $('#container_layout');
  var themeDirectionSelect = $('#theme_direction'); //change the theme typography controller
