...
jQuery(window).on("load", function () {
  ...
  $('#main-wrapper').addClass('show'); // if($('body').attr('data-sidebar-position') === "fixed") {
...
(function ($) {
  ...
  var qs = new PerfectScrollbar('.dlabnav-scroll'); // const sr = new PerfectScrollbar('.sidebar-right-inner');
